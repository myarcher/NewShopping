package com.wangteng.newshopping.base
...
import com.wangteng.newshopping.AppAppliction
import com.wangteng.newshopping.AppManager
import com.wangteng.newshopping.bean.ToastBean
import com.wangteng.newshopping.net.HTTPS
import com.wangteng.newshopping.net.showToast
import com.wangteng.newshopping.service.BService
import com.wangteng.newshopping.toast.ToastCallBackLister
import com.wangteng.newshopping.toast.Types
...
abstract class SActivity : AppCompatActivity(),BaseHttpListener, ToastCallBackLister {
    ...
    fun Https(indexs: Int, call: Call<String>, isShow: Boolean, isCancel: Boolean, backshow: Boolean) {
        addDisposable(HTTPS(this,indexs, call, isShow, isCancel, backshow, this))
    }
